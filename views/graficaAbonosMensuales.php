...
if (!isset($_SESSION['permisos']) || 
    !in_array('abonosmes.ver', $_SESSION['permisos'])) {
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-style mb-30">
                    <h3 class="mb-10 text-center">INGRESOS DE ABONOS PAGADOS POR MES</h3>
                    <div class="graficass">
                        <br>
...
<script src="../js/Chart/graficaAbonoMes.js"></script>
<script src="../js/totalAbonosPagados.js"></script>