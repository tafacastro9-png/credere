        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-style mb-30">
                     <h5 class="modal-title">Reportes Contables</h5>
                    <br>
...
<div class="row g-3 mb-3">
    ...
    <div class="col-md-4">
        ...
        <select id="tipo_reporte" name="tipo_reporte" class="form-control" required>
            ...
            <?php
            $sql = "SELECT * FROM tipo_reporte WHERE id in (6,7)";
...
<div class="col-md-4 d-none" id="filtro_cedula">
...
<div class="col-md-4 d-none" id="filtro_fecha_corte">
    <label><b>Fecha de corte</b></label>
...
if(tipo == 7){
    if(!fecha_corte){
        Swal.fire({
            icon: 'warning',
            title: 'Atención',
            text: 'Seleccione fecha de corte'
        });
        return;
    }
}
    ...
    $.ajax({
        url: "../ajax/reportesContablesAjax.php",
        type: "POST",
        data: {
            tipo_reporte: tipo,
...
$("#tipo_reporte").change(function(){
	...
	$("#filtro_fecha_corte").addClass("d-none");
...
if(tipo == 7){
    $("#filtro_fecha_corte").removeClass("d-none");
}
