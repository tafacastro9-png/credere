...
if (isset($_POST['year'])) {
    ...
    include "db.php";
    $SQL = "SELECT MONTH(fecha_pago) as mes, SUM(monto) as total_mes FROM cuotas_prestamo 
    WHERE YEAR(fecha_pago) = $year AND estado = 'Pendiente' GROUP BY MONTH(fecha_pago)";
